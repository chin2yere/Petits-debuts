...
const businessData = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "./seeders/business.json"), "utf8")
);
const cartData = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "./seeders/cart.json"), "utf8")
);
const orderData = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "./seeders/order.json"), "utf8")
);
const productData = JSON.parse(
  fs.readFileSync(path.resolve(__dirname, "./seeders/product.json"), "utf8")
);
